<template>
    <BasePageContent>
        <BaseCrudTable :edit-dialog="TheGpsStatDialog"
...
import {ref} from "vue";
import TheGpsStatDialog from "@/js/app/pages/gpsStats/dialogs/TheGpsStatDialog.vue";
...
async function handleToggleHidden(value, record) {
    ...
    try {
        await window.axios.put(`api/gps_stats/${record.id}/toggleHidden`);
    } catch (e) {
