<template>
    <BasePageContent>
        <BaseCrudTable :edit-dialog="TheTestimonialDialog"
...
import {ref} from "vue";
import TheTestimonialDialog from "@/js/app/pages/testimonials/dialogs/TheTestimonialDialog.vue";
...
async function handleToggleHidden(value, record) {
  ...
  try {
    await window.axios.put(`api/testimonials/${record.id}/toggleHidden`);
  } catch (e) {
