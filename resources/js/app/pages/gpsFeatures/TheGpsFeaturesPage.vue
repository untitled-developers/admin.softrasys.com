<template>
    <BasePageContent>
        <BaseCrudTable :edit-dialog="TheGpsFeatureDialog"
...
import {ref} from "vue";
import TheGpsFeatureDialog from "@/js/app/pages/gpsFeatures/dialogs/TheGpsFeatureDialog.vue";
...
async function handleToggleHidden(value, record) {
    ...
    try {
        await window.axios.put(`api/gps_features/${record.id}/toggleHidden`);
    } catch (e) {
