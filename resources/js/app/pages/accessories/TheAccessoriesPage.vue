<template>
    <BasePageContent>
        <BaseCrudTable :edit-dialog="TheAccessoryDialog"
...
import {ref} from "vue";
import TheAccessoryDialog from "@/js/app/pages/accessories/dialogs/TheAccessoryDialog.vue";
...
async function handleToggleHidden(value, record) {
    ...
    try {
        await window.axios.put(`api/accessories/${record.id}/toggleHidden`);
    } catch (e) {
