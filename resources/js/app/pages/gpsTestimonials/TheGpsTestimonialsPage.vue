<template>
    <BasePageContent>
        <BaseCrudTable :edit-dialog="TheGpsTestimonialDialog"
...
import {ref} from "vue";
import TheGpsTestimonialDialog from "@/js/app/pages/gpsTestimonials/dialogs/TheGpsTestimonialDialog.vue";
...
async function handleToggleHidden(value, record) {
    ...
    try {
        await window.axios.put(`api/gps_testimonials/${record.id}/toggleHidden`);
    } catch (e) {
