<template>
    <BasePageContent>
        <BaseCrudTable :edit-dialog="TheGpsFaqDialog"
...
import {ref} from "vue";
import TheGpsFaqDialog from "@/js/app/pages/gpsFaqs/dialogs/TheGpsFaqDialog.vue";
...
async function handleToggleHidden(value, record) {
    ...
    try {
        await window.axios.put(`api/gps_faqs/${record.id}/toggleHidden`);
    } catch (e) {
